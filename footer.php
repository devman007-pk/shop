...
<footer class="site-footer site-footer--dark" role="contentinfo">
  <div class="container footer-top">
    ...
    <div class="footer-col footer-about-col">
      <h4>เกี่ยวกับเรา</h4>
      <p>"เราคือผู้เชี่ยวชาญด้านการวางระบบโครงสร้างพื้นฐานเทคโนโลยีสารสนเทศ (ICT Infrastructure) และระบบรักษาความปลอดภัยครบวงจร มุ่งเน้นการส่งมอบโซลูชันที่แม่นยำ ทันสมัย และ 'ตรงต่อเวลา' เพื่อขับเคลื่อนธุรกิจของลูกค้าให้ก้าวหน้าอย่างมีประสิทธิภาพ

ด้วยประสบการณ์ในการออกแบบและติดตั้งระบบ Fiber Optic, CCTV และ Network เราพร้อมเป็นพันธมิตรที่ช่วยจัดการทุกความซับซ้อนด้านเทคโนโลยี ให้เป็นเรื่องง่ายและคุ้มค่าต่อการลงทุน"</p>
    </div>
